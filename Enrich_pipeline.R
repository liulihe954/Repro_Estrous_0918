...
AR_CNTRL_enrich_IP = dplyr::select(AR_CNTRL_enrich_IP,compile_select_index)
#
...
PRF_CNTRL_enrich_IP   = dplyr::select(PRF_CNTRL_enrich_IP,compile_select_index)
### group 2
...
FPM_CNTRL_enrich_IP = dplyr::select(FPM_CNTRL_enrich_IP,compile_select_index)
#
...
SMP_CNTRL_enrich_IP = dplyr::select(SMP_CNTRL_enrich_IP,compile_select_index) 
#
...
SMP_FMP_enrich_IP =  dplyr::select(SMP_FMP_enrich_IP,compile_select_index)
...
write.xlsx(Interpro_Enrich_Regression_005,file = "Interpro_Enrich_Regression_005_0925.xlsx")
Interpro_Enrich_Pregnancy_005 <- list("Full_join" = Interpro_Results_full_005_preg, "Inner_join" = Interpro_Results_inner_005_preg)
write.xlsx(Interpro_Enrich_Pregnancy_005,file = "Interpro_Enrich_Pregnancy_005_0925.xlsx")
