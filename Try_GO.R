...
Enrich_Results_thres005 = Go_Enrich_Plot(total_genes_all,
                                         ...
                                         TestingSubsetNames,
                                         GOthres = 0.05,
                                         keyword = "GO_Enrichment_qval01_pval005_1011")
...
# load results 
#list.files()
load("GO_Enrichment_qval01_pval005_1011.RData")
...
write.xlsx(GO_Enrich_Regression_005,file = "GO_Enrich_Regression_005_1011.xlsx")
GO_Enrich_Pregnancy_005 <- list("Full_join" = GO_Results_full_005_preg, "Inner_join" = GO_Results_inner_005_preg)
write.xlsx(GO_Enrich_Pregnancy_005,file = "GO_Enrich_Pregnancy_005_1011.xlsx")
